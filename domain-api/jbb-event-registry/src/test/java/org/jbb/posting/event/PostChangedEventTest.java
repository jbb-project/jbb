...
public class PostChangedEventTest extends BaseEventTest {
    ...
    public void shouldSetPostId_andTopicId() {
        ...
        PostChangedEvent event = new PostChangedEvent(expectedPostId, expectedTopicId);
    ...
    public void shouldThrowEventValidationException_whenNullPostIdPassed() {
        ...
        Long nullId = null;
        Long topicId = 222L;
        PostChangedEvent event = new PostChangedEvent(nullId, topicId);
    ...
    public void shouldThrowEventValidationException_whenNullTopicIdPassed() {
        ...
        Long postId = 222L;
        Long nullId = null;
        PostChangedEvent event = new PostChangedEvent(postId, nullId);
