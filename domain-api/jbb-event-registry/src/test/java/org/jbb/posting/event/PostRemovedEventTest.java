...
public class PostRemovedEventTest extends BaseEventTest {
    ...
    public void shouldSetPostId() {
        ...
        PostRemovedEvent event = new PostRemovedEvent(expectedPostId, expectedTopicId);
    ...
    public void shouldThrowEventValidationException_whenNullPostIdPassed() {
        ...
        Long nullId = null;
        Long topicId = 222L;
        PostRemovedEvent event = new PostRemovedEvent(nullId, topicId);
    ...
    public void shouldThrowEventValidationException_whenNullTopicIdPassed() {
        ...
        Long postId = 222L;
        Long nullId = null;
        PostRemovedEvent event = new PostRemovedEvent(postId, nullId);
