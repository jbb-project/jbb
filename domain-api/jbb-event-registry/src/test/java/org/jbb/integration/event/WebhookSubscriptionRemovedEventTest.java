...
public class WebhookSubscriptionRemovedEventTest extends BaseEventTest {

    @Test
    public void shouldSetSubscriptionId_andPost() {
        // given
        Long expectedId = 344L;
        WebhookSubscriptionRemovedEvent event = new WebhookSubscriptionRemovedEvent(expectedId);
    ...
    public void shouldThrowEventValidationException_whenNullSubscriptionIdPassed() {
        // given
        Long nullId = null;
        WebhookSubscriptionRemovedEvent event = new WebhookSubscriptionRemovedEvent(nullId);
