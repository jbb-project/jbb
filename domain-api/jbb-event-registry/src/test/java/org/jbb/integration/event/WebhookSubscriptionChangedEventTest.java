...
public class WebhookSubscriptionChangedEventTest extends BaseEventTest {

    @Test
    public void shouldSetSubscriptionId_andPost() {
        // given
        Long expectedId = 344L;
        WebhookSubscriptionChangedEvent event = new WebhookSubscriptionChangedEvent(expectedId);
    ...
    public void shouldThrowEventValidationException_whenNullSubscriptionIdPassed() {
        // given
        Long nullId = null;
        WebhookSubscriptionChangedEvent event = new WebhookSubscriptionChangedEvent(nullId);
