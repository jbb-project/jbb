...
public class OAuthClientChangedEventTest extends BaseEventTest {

    @Test
    public void shouldSetClientId() {
        // given
        String expectedClientId = "service_xydhrcd";
        OAuthClientChangedEvent event = new OAuthClientChangedEvent(expectedClientId);
    ...
    public void shouldThrowEventValidationException_whenNullClientIdPassed() {
        // given
        String nullId = null;
        OAuthClientChangedEvent event = new OAuthClientChangedEvent(nullId);
