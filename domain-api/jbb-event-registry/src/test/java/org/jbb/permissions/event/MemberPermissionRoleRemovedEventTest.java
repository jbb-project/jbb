...
public class MemberPermissionRoleRemovedEventTest extends BaseEventTest {

    @Test
    public void shouldSetRoleId() {
        // given
        Long expectedId = 344L;
        MemberPermissionRoleRemovedEvent event = new MemberPermissionRoleRemovedEvent(expectedId);
    ...
    public void shouldThrowEventValidationException_whenNullRoleIdPassed() {
        // given
        Long nullId = null;
        MemberPermissionRoleRemovedEvent event = new MemberPermissionRoleRemovedEvent(nullId);
