...
public class MemberPermissionRoleChangedEventTest extends BaseEventTest {

    @Test
    public void shouldSetRoleId() {
        // given
        Long expectedId = 344L;
        MemberPermissionRoleChangedEvent event = new MemberPermissionRoleChangedEvent(expectedId);
    ...
    public void shouldThrowEventValidationException_whenNullRoleIdPassed() {
        // given
        Long nullId = null;
        MemberPermissionRoleChangedEvent event = new MemberPermissionRoleChangedEvent(nullId);
