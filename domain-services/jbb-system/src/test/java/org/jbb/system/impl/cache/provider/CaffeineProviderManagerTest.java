...
public class CaffeineProviderManagerTest {
    ...
    @InjectMocks
    CaffeineProviderManager caffeineProviderManager;

    @Test
    public void shouldReturnCorrectProvider() throws Exception {
        // when
        CacheProvider providerName = caffeineProviderManager.getProviderName();

        // then
        assertThat(providerName).isEqualTo(CacheProvider.CAFFEINE);
    }
