...
public interface CacheProviderInstaller {

    boolean isApplicable(CacheProvider cacheProvider);

    void apply(CacheInstallationData cacheInstallationData, CacheSettings cacheSettings);
