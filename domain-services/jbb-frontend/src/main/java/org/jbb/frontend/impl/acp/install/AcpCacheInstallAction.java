...
import static org.jbb.frontend.impl.acp.AcpConstants.CACHE_SETTINGS_ELEMENT;
import static org.jbb.frontend.impl.acp.AcpConstants.CACHE_SETTINGS_VIEW;
...
public class AcpCacheInstallAction implements InstallUpdateAction {
    ...
    public void install(InstallationData installationData) {
        AcpSubcategoryEntity subcategoryEntity = acpSubcategoryRepository
            .findByCategoryViewNameAndName(GENERAL_VIEW, SERVER_CONFIGURATION_SUBCATEGORY);
        acpSubcategoryFactory.addLastElement(subcategoryEntity,
            new AcpElementTuple(CACHE_SETTINGS_ELEMENT, CACHE_SETTINGS_VIEW));
