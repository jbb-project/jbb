...
public class AcpAdministratorPermissionRolesControllerIT extends BaseIT {
    ...
    public void shouldPutRoles_andPermissionToManageFlag_toModel() throws Exception {
        ...
        // when
        ResultActions result = mockMvc.perform(get("/acp/permissions/role-administrators"));

        // then
        result.andExpect(status().isOk())
                .andExpect(view().name("acp/permissions/role-administrators"))
