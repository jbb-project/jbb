...
public class AcpAdministratorPermissionRolesController {

    private static final String VIEW_NAME = "acp/permissions/role-administrators";

    private final PermissionRolesProvider rolesProvider;

    @RequestMapping(method = RequestMethod.GET)
    public String permissionsGet(Model model) {
        model.addAttribute("roles", rolesProvider.getRoleDefinition(ADMINISTRATOR_PERMISSIONS));
