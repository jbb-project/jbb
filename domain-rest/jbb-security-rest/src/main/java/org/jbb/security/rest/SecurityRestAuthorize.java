...
public class SecurityRestAuthorize {
    ...
    public static final String IS_AN_ADMINISTRATOR_OR_OAUTH_PASSWORD_POLICY_READ_SCOPE =
            "(hasRole('ROLE_ADMINISTRATOR') and not #oauth2.isOAuth()) or #oauth2.hasAnyScope('PASSWORD_POLICY_READ', 'PASSWORD_POLICY_READ_WRITE')";
