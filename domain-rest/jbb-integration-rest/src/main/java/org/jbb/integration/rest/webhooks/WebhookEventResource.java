...
import static org.jbb.integration.rest.IntegrationRestAuthorize.IS_AN_ADMINISTRATOR_OR_OAUTH_WEBHOOK_EVENT_READ_DELETE_SCOPE;
...
public class WebhookEventResource {
    ...
    @ErrorInfoCodes({UNAUTHORIZED, FORBIDDEN, WEBHOOK_EVENT_NOT_FOUND})
    @PreAuthorize(IS_AN_ADMINISTRATOR_OR_OAUTH_WEBHOOK_EVENT_READ_DELETE_SCOPE)
