...
import org.jbb.e2e.serenity.web.commons.NotExistsPageSteps;
...
public class GeneralStories extends EndToEndWebStories {
    ...
    @Test
    @WithTagValuesOf({Interface.WEB, Type.SMOKE, Feature.GENERAL, Release.VER_0_3_0})
    ...
    @Test
    @WithTagValuesOf({Interface.WEB, Type.SMOKE, Feature.GENERAL, Release.VER_0_5_0})
    ...
    @Test
    @WithTagValuesOf({Interface.WEB, Type.SMOKE, Feature.GENERAL, Release.VER_0_6_0})
