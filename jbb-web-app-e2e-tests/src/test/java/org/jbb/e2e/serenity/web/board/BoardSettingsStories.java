...
public class BoardSettingsStories extends EndToEndWebStories {
    ...
    @Test
    @WithTagValuesOf({Interface.WEB, Type.REGRESSION, Feature.BOARD_SETTINGS, Release.VER_0_6_0})
    ...
    @Test
    @WithTagValuesOf({Interface.WEB, Type.REGRESSION, Feature.BOARD_SETTINGS, Release.VER_0_9_0})
