...
public class ForumManagementStories extends EndToEndWebStories {
    ...
    @Test
    @WithTagValuesOf({Interface.WEB, Type.REGRESSION, Feature.FORUM_MANAGEMENT, Release.VER_0_8_0})
    ...
    @Test
    @WithTagValuesOf({Interface.WEB, Type.SMOKE, Feature.FORUM_MANAGEMENT, Release.VER_0_8_0})
