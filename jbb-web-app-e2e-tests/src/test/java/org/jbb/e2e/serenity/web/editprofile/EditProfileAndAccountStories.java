...
public class EditProfileAndAccountStories extends EndToEndWebStories {
    ...
    @Test
    @WithTagValuesOf({Interface.WEB, Type.REGRESSION, Feature.EDIT_PROFILE, Release.VER_0_5_0})
    ...
    @Test
    @WithTagValuesOf({Interface.WEB, Type.SMOKE, Feature.EDIT_PROFILE, Release.VER_0_5_0})
