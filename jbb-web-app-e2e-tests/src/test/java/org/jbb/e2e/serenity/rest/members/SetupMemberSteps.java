...
public class SetupMemberSteps extends ScenarioSteps {
    ...
    public Member create_member() {
        ...
        return new Member(member.getId(), registerRequest.getUsername(), registerRequest.getPassword());
    }
    ...
    public EndToEndWebStories.RollbackAction delete_member(Member member) {
        return () -> {
