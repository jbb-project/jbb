...
public class RegistrationStories extends EndToEndWebStories {
    ...
    @Test
    @WithTagValuesOf({Interface.WEB, Type.SMOKE, Feature.REGISTRATION, Release.VER_0_3_0})
    ...
    @Test
    @WithTagValuesOf({Interface.WEB, Type.REGRESSION, Feature.REGISTRATION, Release.VER_0_3_0})
    ...
    @Test
    @WithTagValuesOf({Interface.WEB, Type.REGRESSION, Feature.REGISTRATION, Release.VER_0_4_0})
