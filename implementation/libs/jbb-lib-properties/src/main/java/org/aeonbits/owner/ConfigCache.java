...
public final class ConfigCache {
    ...
    /**
     * Gets from the cache or create, an instance of the given class using the given imports. The
     * factory used to create new instances is the static {@link ConfigFactory#INSTANCE}.
     *
     ...
     * @return an object implementing the given interface, that can be taken from the cache, which
     * maps methods to property values.
     */
    ...
    /**
     * Removes all of the cached instances. The cache will be empty after this call returns.
     */
     ...
     *
     * <p>Returns previous instance associated to the given key in the cache, or <tt>null</tt> if
     * the cache contained no instance for the given key.
     *
     * <p>The cache will not contain the instance for the specified key once the call returns.
     *
     * @param <T> type of the interface.
     * @param key key whose instance is to be removed from the cache.
     * @return the previous instance associated with <tt>key</tt>, or <tt>null</tt> if there was no
     * instance for <tt>key</tt>.
     */
    @SuppressWarnings("unchecked")
