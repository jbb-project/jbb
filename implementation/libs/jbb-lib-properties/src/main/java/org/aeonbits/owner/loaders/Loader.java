...
public interface Loader extends Serializable {
     ...
     * @throws IOException if there is some I/O error during the load.
     * @since 1.1.0
     */
    void load(Properties result, URI uri) throws IOException;

    /**
     * Returns the default URI specification for a given url resource, that can be handled by this
     * loader.
     *
     * @param uriPrefix the prefix identifying the url resource.
     * @return the default URI specification for a given uri resource, that can be handled by this
     * loader.
     */
