...
/**
 * Indicates that whole batch of event must be rolled back. A batch is intended as a group of
 * operations are executed in a row. For instance this happens when the whole list of properties is
 * reloaded or cleared.
 *
