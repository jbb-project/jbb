...
/**
 * Converter interface specifies how to convert an input string coming from a property value to a
 * target object returned by the Config method.
 *
...
public interface Converter<T> {
     ...
     * @param input  the property value specified as input text to be converted to the T return
     *               type
