 ...
 * </pre>
 *
 * <p>The reload method will reload the properties using the same sources used when it was
 * instantiated the first time. This can be useful to programmatically reload the configuration
 * after the configuration files were changed.</p>
 *
