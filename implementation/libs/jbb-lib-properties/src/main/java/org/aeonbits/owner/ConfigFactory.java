...
/**
 * A static factory class to instantiate {@link Config} instances. <p> By default a {@link Config}
 * sub-interface is associated to a property having the same package name and class name as the
 * interface itself.</p> <p> Method names are mapped to property names contained in the property
 * files.</p> <p> This is a singleton static class, to be used as convenience when only a single
 * factory is needed inside an application. It exposes the {@link #newInstance()} method to create
 * new instances of {@link Factory} objects. </p>
 *
...
public final class ConfigFactory {
    ...
    /**
     * Set a property in the ConfigFactory. Those properties will be used to expand variables
     * specified in the `@Source` annotation, or by the ConfigFactory to configure its own
     * behavior.
     *
    ...
    /**
     * Those properties will be used to expand variables specified in the `@Source` annotation, or
     * by the ConfigFactory to configure its own behavior.
     *
    ...
    /**
     * Clears the value for the property having the given key. This means, that the given property
     * is removed.
     *
