...
/**
 * <p>Allows a <tt>Config</tt> object to change its property values at runtime.</p> <p>Example:</p>
 * <pre>
...
public interface Mutable extends Config {
    ...
    /**
     * <p>Sets a given property to the specified value.</p> <p>Differently than {@link
     * java.util.Properties#setProperty(String, String)}, if <tt>key</tt> is set to <tt>null</tt>
     * then this call is equivalent to {@link #removeProperty(String)}.</p>
     *
     * @param key   the key to be placed into the property list.
     * @param value the value corresponding to <tt>key</tt>, or <tt>null</tt> if the property must
     *              be removed.
     ...
     * <code>propertyName</code> or <code>listener</code> is <code>null</code>, no exception is
