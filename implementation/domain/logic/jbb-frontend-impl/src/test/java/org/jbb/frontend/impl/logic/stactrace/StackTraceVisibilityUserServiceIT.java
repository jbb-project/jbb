...
public class StackTraceVisibilityUserServiceIT {
    ...
    public void shouldReturnStack_whenPropertyIsSetToEverybody_andUserIsNotAuthenticated() throws Exception {
        // given
        frontendProperties.setProperty(FrontendProperties.STACK_TRACE_VISIBILITY_USERS, "everybody");

        // when
        Optional<String> stack = stackTraceVisibilityUsersService.getPermissionToStackTraceVisibility(new Exception());
    ...
    public void shouldNotReturnStack_whenPropertyIsSetToUsers_andUserIsNotAuthenticated() throws Exception {
        // given
        frontendProperties.setProperty(FrontendProperties.STACK_TRACE_VISIBILITY_USERS, "users");
    ...
    public void shouldNotReturnStack_whenPropertyIsSetToAdministrators_andUserIsNotAuthenticated() throws Exception {
        // given
        frontendProperties.setProperty(FrontendProperties.STACK_TRACE_VISIBILITY_USERS, "administrators");
    ...
    public void shouldNotReturnStack_whenPropertyIsSetToNobody_andUserIsNotAuthenticated() throws Exception {
        // given
        frontendProperties.setProperty(FrontendProperties.STACK_TRACE_VISIBILITY_USERS, "nobody");
