...
public class EveryoneStackTraceVisibilityStrategyTest {
    @Mock
    private UserDetails userDetailsMock;

    @InjectMocks
    private EveryoneStackTraceVisibilityStrategy strategy;

    @Test
    public void shouldHandle_whenVisibilityValueIsEqualToEverybody() throws Exception {
        // given
        StackTraceVisibilityUsersValues visibility = StackTraceVisibilityUsersValues.EVERYBODY;
    ...
    @Test
    public void shouldNotHandle_whenVisibilityValueIsNotEqualToEverybody() throws Exception {
        // given
        ...
        visibilities.remove(StackTraceVisibilityUsersValues.EVERYBODY);
