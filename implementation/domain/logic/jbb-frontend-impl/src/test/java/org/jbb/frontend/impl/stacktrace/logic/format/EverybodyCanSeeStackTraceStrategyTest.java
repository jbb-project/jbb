...
public class EverybodyCanSeeStackTraceStrategyTest {
    ...
    @InjectMocks
    private EverybodyCanSeeStackTraceStrategy strategy;

    @Test
    public void shouldHandle_whenVisibilityValueIsEqualToEverybody() throws Exception {
        // given
        StackTraceVisibilityLevel visibility = StackTraceVisibilityLevel.EVERYBODY;
    ...
    public void shouldNotHandle_whenVisibilityValueIsNotEqualToEverybody() throws Exception {
        ...
        visibilities.remove(StackTraceVisibilityLevel.EVERYBODY);
