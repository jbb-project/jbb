...
@WebAppConfiguration
@ContextConfiguration(classes = {SystemConfig.class, LoggingConfigMock.class, PropertiesConfig.class, DbConfig.class, CoreConfigMocks.class, SpringSecurityConfigMocks.class})
