...
@WebAppConfiguration
@ContextConfiguration(classes = {SystemConfig.class, PropertiesConfig.class, DbConfig.class, EventBusConfig.class, CoreConfigMocks.class, SpringSecurityConfigMocks.class})
